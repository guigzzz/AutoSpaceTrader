...
impl JumpShip200ResponseData {
    pub fn new(nav: crate::models::ShipNav, cooldown: crate::models::Cooldown, transaction: crate::models::MarketTransaction, agent: crate::models::Agent) -> JumpShip200ResponseData {
