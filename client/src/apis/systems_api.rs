...
pub async fn supply_construction(configuration: &configuration::Configuration, system_symbol: &str, waypoint_symbol: &str, supply_construction_request: Option<crate::models::SupplyConstructionRequest>) -> Result<crate::models::SupplyConstruction201Response, Error<SupplyConstructionError>> {
    let local_var_configuration = configuration;
